...
// [[rc::parameters("p : loc", "t : {tree type}")]]
// [[rc::args("p @ &own<t @ tree_t>")]]
// [[rc::requires("{size_tree_coq t ≤ max_int size_t}")]]
// [[rc::returns("{size_tree_coq t} @ int<size_t>")]]
...
// [[rc::ensures("own p : {insert_leftmost_coq t u} @ tree_t")]]
...
[[rc::tactics("all : try f_equal; simpl; lia.")]]
...
// [[rc::ensures("own p : t @ tree_t")]]
[[rc::lemmas("PI_size_tree_ul", "PI_size_tree_lr", "size_zip_tree")]]
[[rc::tactics("all : try by rewrite size_map_tree.")]]
...
// add mutable payload to callback
